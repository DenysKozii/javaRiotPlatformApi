...
import platform.utils.riot.api.endpoints.static_data.dto.Champion;
import platform.utils.riot.api.endpoints.static_data.dto.ChampionList;
...
import platform.utils.riot.api.endpoints.static_data.dto.ItemList;
import platform.utils.riot.api.endpoints.static_data.dto.LanguageStrings;
import platform.utils.riot.api.endpoints.static_data.dto.MapData;
import platform.utils.riot.api.endpoints.static_data.dto.Mastery;
import platform.utils.riot.api.endpoints.static_data.dto.MasteryList;
import platform.utils.riot.api.endpoints.static_data.dto.ProfileIconData;
import platform.utils.riot.api.endpoints.static_data.dto.Realm;
import platform.utils.riot.api.endpoints.static_data.dto.ReforgedRune;
import platform.utils.riot.api.endpoints.static_data.dto.ReforgedRunePath;
import platform.utils.riot.api.endpoints.static_data.dto.Rune;
import platform.utils.riot.api.endpoints.static_data.dto.RuneList;
import platform.utils.riot.api.endpoints.static_data.dto.SummonerSpell;
import platform.utils.riot.api.endpoints.static_data.dto.SummonerSpellList;
...
public class RiotApi implements Cloneable {
	 ...
	 * @see Champion
	 */
	public Champion getDataChampion(Platform platform, int id, Locale locale, String version,
	 ...
	 * @see ChampionList
	 */
	public ChampionList getDataChampionList(Platform platform, Locale locale, String version, boolean dataById,
	 ...
	 * @see Match
	 */
	public Match getMatch(Platform platform, String matchId, String forAccountId) throws RiotApiException {
		Objects.requireNonNull(platform);
	 ...
	 * @see Match
	 */
	public Match getMatch(Platform platform, String matchId) throws RiotApiException {
	 ...
	 * @see MatchTimeline
	 */
	public MatchTimeline getTimelineByMatchId(Platform platform, String matchId) throws RiotApiException {
		Objects.requireNonNull(platform);
